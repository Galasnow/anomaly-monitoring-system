...
const tiffApiUrl = `${backendUrlPrefix}/files_Chummur`;
const mainScriptUrl = `${backendUrlPrefix}/run_main_Chummur`;
const finishResponseUrl = `${backendUrlPrefix}/files_txt_Chummur`;
