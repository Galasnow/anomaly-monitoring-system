...
const tiffRootPath = "/03_India_Airport/03_Dehradun_Airport/02_Output";
const csvPath =
  "/03_India_Airport/03_Dehradun_Airport/Dehradun_Airport_Area.csv";
const tiffApiUrl = `${backendUrlPrefix}/files_Dehradun`;
const mainScriptUrl = `${backendUrlPrefix}/run_main_Dehradun`;
const finishResponseUrl = `${backendUrlPrefix}/files_txt_Dehradun`;
