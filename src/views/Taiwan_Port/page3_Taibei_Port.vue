...
const tiffApiUrl = "http://localhost:3017/api/files_Taibei";
const mainScriptUrl = "http://localhost:3017/api/run_main_Taibei";
const finishResponseUrl = "http://localhost:3017/api/files_txt_Taibei";
...
async function initCesium() {
  ...
  viewer.value.camera.setView({
    destination: Cesium.Cartesian3.fromDegrees(121.37277, 25.1603, 6200.0),
  });
}
