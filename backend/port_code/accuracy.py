...
accuracy_df = pd.read_csv(r"../public/01_TaiWan_Port/02_Gaoxiong_Port/Gaoxiong_Port_Accuracy.csv")
area_df = pd.read_csv(r"../public/01_TaiWan_Port/02_Gaoxiong_Por/Gaoxiong_Port_Area.csv")
...
# 保存修改后的 CSV 文件
accuracy_df.to_csv(r"../public/01_TaiWan_Port/02_Gaoxiong_Port/Gaoxiong_Port_Accuracy_Updated.csv", index=False, encoding='utf-8-sig')

print(area_df['abnormal'])
# 打印准确率
