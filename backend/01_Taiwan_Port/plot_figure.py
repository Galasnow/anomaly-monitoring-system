...
if __name__ == "__main__":
    wm_file_path = r'../public/01_TaiWan_Port/01_Taibei_Port/result/plt/Image'
    output_path = r'../public/01_TaiWan_Port/01_Taibei_Port/result/0.png'
    generate_test_image_plots(wm_file_path, output_path)
