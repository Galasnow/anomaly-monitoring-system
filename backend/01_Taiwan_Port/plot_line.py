...
def plot_area_data(area_csv, start_date='2016/01/01', tolerance=0.005, area_line=None,
    ...
    ax1.set_ylabel('面积 (km$\\mathrm{^2}$)', fontsize=28)
...
if __name__ == "__main__":
    ...
    area_result = main_dir + r"Gaoxiong_Port_Area.csv"
    line_result = main_dir + r"Gaoxiong_Port_Area.png"
    accuracy_csv = main_dir + r"Gaoxiong_Port_Accuracy.csv"
    plot_area_data(
