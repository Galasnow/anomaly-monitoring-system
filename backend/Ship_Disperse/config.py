...
# stem_path = 'D:/zhongyan/test_area/'
...
# input_shp_path = f'F:/zhongyan/gee_download_weizhou/weizhou_oil_field_range/weizhou_oil_field.shp'
input_shp_path = f'H:/zhongyan/gee_download_wenlai/malaysia_range_for_test/malaysia_range_for_test.shp'
