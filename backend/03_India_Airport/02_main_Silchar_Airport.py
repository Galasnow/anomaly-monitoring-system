...
if __name__ == "__main__":
  ...
  main_dir = r"../public/03_India_Airport/02_Silchar_Airport/"
  ...
  area_result = main_dir + r"Silchar_Airport_Area.csv"
  batch_calculate_white_area(result_merge_dir, pixel_area, area_result)
  #
  # # # -----------------step 5:根据面积变化获取异常日期并绘制图表-----------------
  line_result = main_dir + r"test/Silchar_Airport_Area.png"
  accuracy_csv = main_dir + r"Silchar_Airport_Accuracy.csv"
  plot_area_data(
