...
if __name__ == "__main__":
  ...
  main_dir = r"../public/03_India_Airport/05_Lengpui_Airport/"
  ...
  model_file_path = os.path.join(current_path, f"./model/model_Lengpui.pth")
  ...
  area_result = main_dir + r"Lengpui_Airport_Area.csv"
  batch_calculate_white_area(result_merge_dir, pixel_area, area_result)
  #
  # # # -----------------step 5:根据面积变化获取异常日期并绘制图表-----------------
  line_result = main_dir + r"test/Lengpui_Airport_Area.png"
  accuracy_csv = main_dir + r"Lengpui_Airport_Accuracy.csv"
  plot_area_data(
