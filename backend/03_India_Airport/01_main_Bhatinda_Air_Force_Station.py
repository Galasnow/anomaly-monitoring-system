...
if __name__ == "__main__":
  ...
  main_dir = r"../public/03_India_Airport/01_Bhatinda_Air_Force_Station/"
  ...
  area_result = main_dir + r"Bhatinda_Air_Force_Station_Area.csv"
  batch_calculate_white_area(result_merge_dir, pixel_area, area_result)
  #
  # # # -----------------step 5:根据面积变化获取异常日期并绘制图表-----------------
  line_result = main_dir + r"test/Bhatinda_Air_Force_Station_Area.png"
  accuracy_csv = main_dir + r"Bhatinda_Air_Force_Station_Accuracy.csv"
  plot_area_data(
