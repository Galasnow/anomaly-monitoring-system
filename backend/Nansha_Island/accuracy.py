...
accuracy_df = pd.read_csv(r"E:\04_ZhongyanExperiment\03_TaiWan_Port\00_TaiWan_Port_Test\01_Taibei_Port\Taibei_Port_Accuracy.csv")
area_df = pd.read_csv(r"E:\04_ZhongyanExperiment\03_TaiWan_Port\00_TaiWan_Port_Test\01_Taibei_Port\Taibei_Port_Area.csv")
...
# 保存修改后的 CSV 文件
accuracy_df.to_csv(r"E:\04_ZhongyanExperiment\03_TaiWan_Port\00_TaiWan_Port_Test\01_Taibei_Port\Taibei_Port_Accuracy_Updated.csv", index=False, encoding='utf-8-sig')
