...
if __name__ == "__main__":
  ...
  main_dir = r"../public/02_India_Base/01_Durbuk_Base/"
  ...
  model_file_path = os.path.join(current_path, f"./model/model_Durbuk.pth")
  ...
  area_result = main_dir + r"Durbuk_Base_Area.csv"
  batch_calculate_white_area(result_merge_dir, pixel_area, area_result)
  #
  # # # -----------------step 5:根据面积变化获取异常日期并绘制图表-----------------
  line_result = main_dir + r"test/Durbuk_Base_Area.png"
  accuracy_csv = main_dir + r"Durbuk_Base_Accuracy.csv"
  plot_area_data(
