...
if __name__ == "__main__":
  ...
  main_dir = r"../public/02_India_Base/02_Chummur_Base/"
  ...
  model_file_path = os.path.join(current_path, f"./model/model_Chummur.pth")
  ...
  area_result = main_dir + r"Chummur_Base_Area.csv"
  batch_calculate_white_area(result_merge_dir, pixel_area, area_result)
  #
  # # # -----------------step 5:根据面积变化获取异常日期并绘制图表-----------------
  line_result = main_dir + r"test/Chummur_Base_Area.png"
  accuracy_csv = main_dir + r"Chummur_Base_Accuracy.csv"
  plot_area_data(
